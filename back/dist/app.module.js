...
AppModule = __decorate([
    common_1.Module({
        imports: [],
        controllers: [app_controller_1.AppController, shortener_controller_1.ShortenerController],
        providers: [shortener_service_1.ShortenerService, prisma_service_1.PrismaService],
    })
], AppModule);
